...
bool is_phase_solved(int phase); // Returns whether the give phase is solved 
 ...
 *	current phase. If the secret string is not empty, we add a space 
 ...
 *	Checks if given string matches the secret string for the current
